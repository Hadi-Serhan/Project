...
// Expose default/wrapping capability to mods without touching main.js
Engine.setDefaultWaveRecipe(waveRecipe);
Engine.setWaveRecipeBridge((fn) => {
  if (typeof fn === 'function') {
    waveRecipe = fn; // replace the exported binding
  } else {
    waveRecipe = Engine.defaultWaveRecipe; // fallback
  }
});
